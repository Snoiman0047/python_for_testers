...
class MobileDevice(object):
    ...
    def __init__(self, model='', os='', version=0.0, has_flash=False, price=0, screen_width=0.0, screen_height=0.0):
        ...
        print("Screen width is a negative number") if screen_width < 0 else print("Screen width is alright")
        print("Screen height is a negative number") if screen_width < 0 else print("Screen height is alright")
